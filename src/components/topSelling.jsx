...
const TopSelling = () => {
  return (
    <div className="w-full max-w-[1440px] mx-auto px-15 pb-20 lg:pl-18">
      <h1 className="font-bold text-[48px] font-integral text-center my-15 uppercase bg-gradient-to-r from-black to-white bg-clip-text text-transparent animate-gradient">
        Top Selling
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-6">
        {database.slice(4, 8).map((product) => (
